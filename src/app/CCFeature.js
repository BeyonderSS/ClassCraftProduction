      ...
      <div className="container my-24 px-6 mx-auto">
        ...
        <section className="mb-32 text-gray-200">
          <h2 className="text-3xl font-bold mb-12 text-center ">
            Why is it so great<span className="text-blue-600"> Features ?</span>
          </h2>
          <div className="flex flex-wrap items-center">
            <div className="grow-0 shrink-0 basis-auto w-full lg:w-5/12 mb-12 lg:mb-0 md:px-6">
              <motion.div
                ...
                variants={variants}
                animateOnce
                className="relative overflow-hidden bg-no-repeat bg-cover rounded-lg shadow-2xl"
                data-mdb-ripple="true"
                data-mdb-ripple-color="light"
                style={{ backgroundPosition: "50%" }}
              >
                <img src="/teaching-animate.svg" className="w-full py-10" />
                <a href="#!">
                  <div
