  ...
  return (
    <>
      ...
      <div className="container my-10 mx-auto">
        ...
        <section className="">
          <div className="bg-red-500 alert alert-dismissible fade show rounded-lg py-4 px-6 text-white md:flex justify-between items-center text-center md:text-left">
            <div className="mb-4 md:mb-0 flex items-center flex-wrap justify-center md:justify-start">
              ...
              <strong className="mr-1">Limited offer!</strong> Get it now before
              it&apos;s to late
            </div>
