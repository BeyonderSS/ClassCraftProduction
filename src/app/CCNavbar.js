...
const CCHeader = () => {
  ...
  return (
    <>
      <nav className="relative px-4 py-4 flex justify-between items-center bg-gray-300/90  backdrop-blur-xl">
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
          ...
          >
            <Link className="text-4xl text-blue-600 font-bold" href="/">
              ClassCraft
            </Link>
          </motion.li>
        </ul>
