    ...
    <>
      ...
      <div className="container py-24 px-6 mx-auto">
        ...
        <section className="mb-32 text-gray-800 text-center">
          <h2 className="text-3xl font-bold mb-32 text-gray-100">
            ClassCraft is designed with <u className="text-blue-300">You</u> in
            mind.
          </h2>
